...
balPartP.innerHTML += `<img src="kepek/rendor.png" alt="">`+`<img src="kepek/brendon.png" alt="">`+`<img src="kepek/vas.png" alt="">`
...
function mozgat(event){
    ...
    if (jobbPartP.querySelectorAll("img").length === 3) {
        alert("Sikeresen hazajuttattad Brendonékat!");
        location.reload();
    }
}
...
function megEsz() {
    ...
    if(balPartP.querySelectorAll("img").length === 2 && csonak.classList.contains("csonak-jobboldalt")){
        if(balPartP.querySelectorAll("img")[0].src.includes("kepek/rendor.png") && balPartP.querySelectorAll("img")[1].src.includes("kepek/brendon.png")) {
            alert("Brendont letartóztatták 71 évre rendőr elleni testi sértésért, nagyértékű lopásért, Olaszország elleni hadüzenet kihírdetéséért, közszeméremsértésért, robbanószer elhelyezéséért egy mentális egészségügyi intézményben, ittas állapotban szamuráj karddal való utcai táncolásért, és egy víziló szabadon bocsátásáért Zalaegerszeg belvárosában!");
            location.reload();
        }
        if(balPartP.querySelectorAll("img")[1].src.includes("kepek/rendor.png") && balPartP.querySelectorAll("img")[0].src.includes("kepek/brendon.png")) {
            alert("Brendont letartóztatták 71 évre rendőr elleni testi sértésért, nagyértékű lopásért, Olaszország elleni hadüzenet kihírdetéséért, közszeméremsértésért, robbanószer elhelyezéséért egy mentális egészségügyi intézményben, ittas állapotban szamuráj karddal való utcai táncolásért, és egy víziló szabadon bocsátásáért Zalaegerszeg belvárosában!");
            location.reload();
        }
        if(balPartP.querySelectorAll("img")[0].src.includes("kepek/vas.png") && balPartP.querySelectorAll("img")[1].src.includes("kepek/brendon.png")) {
            alert("A vas eltűnt!");
            location.reload();
        }
        if(balPartP.querySelectorAll("img")[1].src.includes("kepek/vas.png") && balPartP.querySelectorAll("img")[0].src.includes("kepek/brendon.png")) {
            alert("A vas eltűnt!");
            location.reload();
        }
    }
    ...
    if(jobbPartP.querySelectorAll("img").length === 2 && csonak.classList.contains("csonak-baloldalt")){
        if(jobbPartP.querySelectorAll("img")[0].src.includes("kepek/rendor.png") && jobbPartP.querySelectorAll("img")[1].src.includes("kepek/brendon.png")) {
            alert("Brendont letartóztatták 71 évre rendőr elleni testi sértésért, nagyértékű lopásért, Olaszország elleni hadüzenet kihírdetéséért, közszeméremsértésért, robbanószer elhelyezéséért egy mentális egészségügyi intézményben, ittas állapotban szamuráj karddal való utcai táncolásért, és egy víziló szabadon bocsátásáért Zalaegerszeg belvárosában!");
            location.reload();
        }
        if(jobbPartP.querySelectorAll("img")[1].src.includes("kepek/rendor.png") && jobbPartP.querySelectorAll("img")[0].src.includes("kepek/brendon.png")) {
            alert("Brendont letartóztatták 71 évre rendőr elleni testi sértésért, nagyértékű lopásért, Olaszország elleni hadüzenet kihírdetéséért, közszeméremsértésért, robbanószer elhelyezéséért egy mentális egészségügyi intézményben, ittas állapotban szamuráj karddal való utcai táncolásért, és egy víziló szabadon bocsátásáért Zalaegerszeg belvárosában!");
            location.reload();
        }
        if(jobbPartP.querySelectorAll("img")[0].src.includes("kepek/vas.png") && jobbPartP.querySelectorAll("img")[1].src.includes("kepek/brendon.png")) {
            alert("A vas eltűnt!");
            location.reload();
        }
        if(jobbPartP.querySelectorAll("img")[1].src.includes("kepek/vas.png") && jobbPartP.querySelectorAll("img")[0].src.includes("kepek/brendon.png")) {
            alert("A vas eltűnt!");
            location.reload();
        }
    }
